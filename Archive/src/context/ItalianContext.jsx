  ...
  const fetchParagraph = async (description) => {
    ...
    try {
      ...
      const completion = await openai.chat.completions.create({
        model: model,
        messages: [
          { role: 'system', content: 'you are a long paragraph writer. you will write as much as possible about everyday stuff. the user will describe a sitation or subject to talk about. and you will follow it. give 100 words maximum. devide the lines with a multiline' },
